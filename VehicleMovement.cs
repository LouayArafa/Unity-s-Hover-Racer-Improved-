...
public class VehicleMovement : MonoBehaviour
{
    ...
    void CalculatHover()
    {
        ...
        if (isOnGround)
        {
            ...
            // Adjust the hover gravity based on the height to provide smoother transitions
            Vector3 gravity = -groundNormal * Mathf.Lerp(hoverGravity, fallGravity, height / maxGroundDist);

            // Apply the hover and gravity forces
            rigidBody.AddForce(force, ForceMode.Acceleration);
            rigidBody.AddForce(gravity, ForceMode.Acceleration);
        }
        // If the ship is not on the ground...
        else
        {
        ...
        // This is done smoothly (using Lerp) to make it feel more realistic
        ...
        // It is worth noting that these next few steps are completely optional and are cosmetic.
    ...
    void CalculatePropulsion()
    {
        ...
        Vector3 sideFriction = -transform.right * (sidewaysSpeed / Time.fixedDeltaTime / 30);
